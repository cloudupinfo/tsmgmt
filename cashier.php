			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="page-header">
						<h1>Cashier Search Chassis No</h1>
					</div>
					<div id="nestable-menu" class="pull-right">
						<a href="cashier_list_today.php" class="btn btn-primary btn-squared">Cashier Add Today Veihicle List</a>
				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal" method="post" action="model/cashierManage.php" id="cashier_search" name="cashier_search" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="submit" id="cashier-search" class="btn btn-success btn-squared" value="Search">
									</div>
								</div>
							</form>
						</div>
