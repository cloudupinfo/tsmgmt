			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div id="nestable-menu" class="pull-right">
						<a href="rto.php" class="btn btn-primary btn-squared">RTO Search</a>
						<a href="rto_list.php" class="btn btn-primary btn-squared">RTO List</a>
					</div>
		...
		if (confirm('Are you sure you want to delete this RTO ?')) {
			$.ajax({
				...
				success : function(result) {
					...
					if (result==0) {
						alert("Delete RTO Successfully");
						table.row('.selected').remove().draw(false);
						table.ajax.reload();
					} else if(result==1) {
						alert("Does not delete RTO : \n" + result);
