...
$customerPayment = $db->getRow("SELECT * FROM ".$table." where `customer_payment_id`=?",array($id));
if($customerPayment){
	$type = "customer_payment_detail_edit";
}else{
	header('Location:dashboard.php');
	exit();
}
...
<div class="main-container">
	...
	<div class="main-content">
		...
		<div class="container">
			...
			<!-- start: PAGE CONTENT -->
			<div class="row">
				<form class="form-horizontal" method="post" action="model/editManage.php" id="cashier_payment_add_frm" name="cashier_payment_add_frm" enctype="multipart/form-data">
					<input type="hidden" value="<?php echo $type;?>" name="type">
					<input type="hidden" value="<?php echo $_SESSION['admin_id'];?>" name="admin_id">
					<input type="hidden" value="<?php echo $customerPayment['customer_payment_id'];?>" name="id">
					
					<span class="pull-right">Date: <input type="text" name="currentDate" class="currentDate date-picker" value="<?php echo !empty($customerPayment['created_at']) ? date("d-m-Y",strtotime($customerPayment['created_at'])) : date("d-m-Y"); ?>"></span>
					<div class="col-sm-12">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<?php !empty($customerPayment['case_type']) ? $paymentType = $customerPayment['case_type'] : $paymentType="Cash";?>
						...
						<div class="by_case_cheque" style="<?php echo $paymentType=="Cheque" ? 'display:block' : 'display:none';?>;">
							<div class="form-group">
								...
								<div class="col-sm-7">
									<div class="input-group">
										<input type="text" placeholder="Bank Name" id="bank_name" class="form-control" name="bank_name" value="<?php echo !empty($customerPayment['bank_name']) ? $customerPayment['bank_name'] : '' ?>">
										
										<?php //!empty($customerPayment['bank_name']) ? $bankName = $customerPayment['bank_name'] : $bankName="";?>
										<!--
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" placeholder="Cheque No" id="cheque_no" class="form-control" name="cheque_no" value="<?php echo !empty($customerPayment['cheque_no']) ? $customerPayment['cheque_no'] : '' ?>">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="form-field-1">
								...
								<div class="col-sm-7">
									<div class="input-group">
										<input type="text" placeholder="Cheque Date" id="cheque_date" class="form-control date-picker" name="cheque_date" value="<?php echo !empty($customerPayment['cheque_date']) ? date("d-m-Y",strtotime($customerPayment['cheque_date'])) : '' ?>">
						...
						<div class="by_case_dd" style="<?php echo $paymentType=="DD" ? 'display:block' : 'display:none';?>;">
							<div class="form-group">
								...
								<div class="col-sm-7">
									<div class="input-group">
										<input type="text" placeholder="Bank Name" id="dd_bank_name" class="form-control" name="dd_bank_name" value="<?php echo !empty($customerPayment['dd_bank_name']) ? $customerPayment['dd_bank_name'] : '' ?>">
						...
						<div class="by_case_neft" style="<?php echo $paymentType=="NEFT" ? 'display:block' : 'display:none';?>;">
							<div class="form-group">
								...
								<div class="col-sm-7">
									<div class="input-group">
										<input type="text" placeholder="Bank Name" id="neft_bank_name" class="form-control" name="neft_bank_name" value="<?php echo !empty($customerPayment['neft_bank_name']) ? $customerPayment['neft_bank_name'] : '' ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<div class="input-group">
									<input type="text" placeholder="Price" id="price" class="form-control" readonly name="price" value="<?php echo !empty($customerPayment['price']) ? $customerPayment['price'] : '';?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" placeholder="Amount In Word" id="amount_in_word" class="form-control" name="amount_in_word" value="<?php echo !empty($customerPayment['amount_in_word']) ? $customerPayment['amount_in_word'] : '' ?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="form-field-1">
