			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="page-header">
						<h1>Cashier Extra Manage </h1>
					</div>
					<div id="nestable-menu" class="pull-right">
						<a href="expense.php" class="btn btn-primary btn-squared">Cashier Add</a>
					</div>
...
$(document).ready(function() {
	table = $('#loadmaincat').DataTable({    
		"ajax" : {
			"url" : "model/cashierExtraList.php",
			"dataSrc": "data",
			"type" : "POST",
			"data" : {
				"list" : "list"
	...
	$(document).on("click", ".to_delete", function(e) {
		...
		var a_delete = "cashier_extra_delete";
