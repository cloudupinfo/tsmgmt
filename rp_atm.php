...
if($_POST){
	...
	// ATM Collect Stock
	$atm = $db->getRows("SELECT * FROM `atm` where `created_at` BETWEEN ? AND ? ORDER BY `created_at` DESC",array($date_to,$date_from));
}
$atmTotal = 0;
		...
		<div class="container">
			...
			<div class="col-sm-12">
				...
				<div class="col-xm-12 print-report" id="print-report">
				  ...
				  <h3>Total Cash <?php echo $atmTotal;?></h3>
				</div>
			</div>
			</div>
		</div>
