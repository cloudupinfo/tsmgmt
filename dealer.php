				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal" method="post" action="model/dealerManage.php" id="dealer_search" name="dealer_search" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="submit" id="dealer-search" class="btn btn-success btn-squared" value="Search">
									</div>
								</div>
							</form>
						</div>
...
$(document).ready(function(){
	...
	$("#search").keypress(function() {
		var search = $(this).val();
		var type = "dealer_search";
		if(search.length >= 4){
		$.ajax({
			url : "model/dealerManage.php",
			cache : false,
			data : {
