			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div id="nestable-menu" class="pull-right">
						<a href="rto_today_list.php" class="btn btn-primary btn-squared">RTO Add Today List</a>
						<a href="rto_list.php" class="btn btn-primary btn-squared">RTO All List</a>
						<a href="rto_list_service.php" class="btn btn-primary btn-squared">Service All List</a>
					</div>
				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal" method="post" action="model/rtoManage.php" id="rto_search" name="rto_search" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="submit" id="rto-search" class="btn btn-success btn-squared" value="Search">
									</div>
								</div>
							</form>
						</div>
