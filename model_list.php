			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div id="nestable-menu" class="pull-right">
						<a href="model.php" class="btn btn-primary btn-squared">Model Add</a>
					</div>
...
$(document).ready(function() {
	...
	$('#loadmaincat').dataTable({    
		...
		"columns" : [{
			...
			"data" : "2_year_insurance"
		},{
			"data" : "3_year_insurance"
		},{
			"data" : "weight"
		},{
			"data" : "cc"
