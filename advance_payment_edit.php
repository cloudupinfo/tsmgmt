...
$advancePayment = $db->getRow("SELECT * FROM ".$table." where `advance_payment_id`=?",array($id));
if($advancePayment){
	$type = "advance_payment_detail_edit";
}else{
	header('Location:dashboard.php');
	exit();
}
...
<div class="main-container">
	...
	<div class="main-content">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="page-header">
						<h3>Payment Detail Edit - <small class="required-field">* asterisk mark will be compulsory</small></h3>
					</div>
			...
			<!-- start: PAGE CONTENT -->
			<div class="row">
				<form class="form-horizontal" method="post" action="model/editManage.php" id="advance_payment_edit_frm" name="advance_payment_edit_frm" enctype="multipart/form-data">
					<input type="hidden" value="<?php echo $type;?>" name="type">
					<input type="hidden" value="<?php echo $_SESSION['admin_id'];?>" name="admin_id">
					<input type="hidden" value="<?php echo $advancePayment['advance_payment_id'];?>" name="id">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<?php !empty($advancePayment['case_type']) ? $paymentType = $advancePayment['case_type'] : $paymentType="Cash";?>
								...
								<?php } ?>
								<?php if($paymentType=="DD"){?>
								<input type="radio" class="case_by_dd" name="case_type" value="DD" <?php echo $paymentType=="DD" ? 'checked' : '';?>> Demand Draft &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
								<?php } ?>
								<?php if($paymentType=="NEFT"){?>
						...
						<div class="by_case_cheque" style="<?php echo $paymentType=="Cheque" ? 'display:block' : 'display:none';?>;">
							<div class="form-group">
								...
								<div class="col-sm-7">
									<div class="input-group">
										<input type="text" placeholder="Bank Name" id="bank_name" class="form-control" name="bank_name" value="<?php echo !empty($advancePayment['bank_name']) ? $advancePayment['bank_name'] : '' ?>">
										
										<?php //!empty($advancePayment['bank_name']) ? $bankName = $advancePayment['bank_name'] : $bankName="";?>
										<!--
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" placeholder="Cheque No" id="cheque_no" class="form-control" name="cheque_no" value="<?php echo !empty($advancePayment['cheque_no']) ? $advancePayment['cheque_no'] : '' ?>">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="form-field-1">
								...
								<div class="col-sm-7">
									<div class="input-group">
										<input type="text" placeholder="Cheque Date" id="cheque_date" class="form-control date-picker" name="cheque_date" value="<?php echo !empty($advancePayment['cheque_date']) ? date("d-m-Y",strtotime($advancePayment['cheque_date'])) : '' ?>">
						...
						<div class="by_case_dd" style="<?php echo $paymentType=="DD" ? 'display:block' : 'display:none';?>;">
							<div class="form-group">
								...
								<div class="col-sm-7">
									<div class="input-group">
										<input type="text" placeholder="Bank Name" id="dd_bank_name" class="form-control" name="dd_bank_name" value="<?php echo !empty($advancePayment['dd_bank_name']) ? $advancePayment['dd_bank_name'] : '' ?>">
										
										<?php //!empty($advancePayment['dd_bank_name']) ? $ddBankName = $advancePayment['dd_bank_name'] : $ddBankName="";?>
										<!--
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" placeholder="DD No" id="dd_no" class="form-control" name="dd_no" value="<?php echo !empty($advancePayment['dd_no']) ? $advancePayment['dd_no'] : '' ?>">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="form-field-1">
								...
								<div class="col-sm-7">
									<div class="input-group">
										<input type="text" placeholder="DD Date" id="dd_date" class="form-control date-picker" name="dd_date" value="<?php echo !empty($advancePayment['dd_date']) ? date("d-m-Y",strtotime($advancePayment['dd_date'])) : '' ?>">
										<span class="input-group-addon"> <i class="fa fa-calendar"></i> </span>
									</div>
								</div>
							</div>
						...
						<div class="by_case_neft" style="<?php echo $paymentType=="NEFT" ? 'display:block' : 'display:none';?>;">
							<div class="form-group">
								...
								<div class="col-sm-7">
									<div class="input-group">
										<input type="text" placeholder="Bank Name" id="neft_bank_name" class="form-control" name="neft_bank_name" value="<?php echo !empty($advancePayment['neft_bank_name']) ? $advancePayment['neft_bank_name'] : '' ?>">
										
										<?php //!empty($advancePayment['neft_bank_name']) ? $neftBankName = $advancePayment['neft_bank_name'] : $neftBankName="";?>
										<!--
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" placeholder="NEFT/RTGS Account No" id="neft_ac_no" class="form-control" name="neft_ac_no" value="<?php echo !empty($advancePayment['neft_ac_no']) ? $advancePayment['neft_ac_no'] : '' ?>">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="form-field-1">
								...
								<div class="col-sm-7">
									<input type="text" placeholder="NEFT/RTGS IFSC Code" id="neft_ifsc_code" class="form-control" name="neft_ifsc_code" value="<?php echo !empty($advancePayment['neft_ifsc_code']) ? $advancePayment['neft_ifsc_code'] : '' ?>">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="form-field-1">
								...
								<div class="col-sm-7">
									<div class="input-group">
										<input type="text" placeholder="NEFT/RTGS Holder Name" id="neft_holder_name" class="form-control" name="neft_holder_name" value="<?php echo !empty($advancePayment['neft_holder_name']) ? $advancePayment['neft_holder_name'] : '' ?>">
										<span class="input-group-addon"> <i class="fa fa-calendar"></i> </span>
									</div>
								</div>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<div class="input-group">
									<input type="text" placeholder="Price" id="price" class="form-control" readonly name="price" value="<?php echo !empty($advancePayment['price']) ? $advancePayment['price'] : '';?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" placeholder="Amount In Word" id="amount_in_word" class="form-control" name="amount_in_word" value="<?php echo !empty($advancePayment['amount_in_word']) ? $advancePayment['amount_in_word'] : '' ?>">
							</div>
						</div>
