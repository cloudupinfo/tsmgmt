				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal" method="post" action="model/productManage.php" id="direct_sale_search" name="direct_sale_search" enctype="multipart/form-data">
								...
								?>
								<input type="hidden" value="direct_sale" name="type">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="submit" id="veihicle-status-search" class="btn btn-success btn-squared" value="Direct Sale">
									</div>
								</div>
							</form>
						</div>
