			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="page-header">
						<h1>Service List All</h1>
					</div>
					<div id="nestable-menu" class="pull-right">
						<a href="billing.php" class="btn btn-primary btn-squared">Billing Search</a>
						<a href="billing_today_list.php" class="btn btn-primary btn-squared">Billing List Today</a>
...
$(document).ready(function() {
	table = $('#loadmaincat').DataTable({    
		"ajax" : {
			"url" : "model/billingListService.php",
			"dataSrc": "data",
			"type" : "POST",
			"data" : {
				"list" : "list",
