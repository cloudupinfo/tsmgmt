			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="page-header">
						<h1>Billing Search</h1>
					</div>
					<div id="nestable-menu" class="pull-right">
						<a href="billing_today_list.php" class="btn btn-primary btn-squared">Billing Add Today List</a>
						<a href="billing_list.php" class="btn btn-primary btn-squared">Billing All List</a>
						<a href="billing_list_service.php" class="btn btn-primary btn-squared">Service All List</a>
					</div>
				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-horizontal" method="post" action="model/billingManage.php" id="billing_search" name="billing_search" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="submit" id="billing-search" class="btn btn-success btn-squared" value="Search">
									</div>
								</div>
							</form>
						</div>
...
$(function(){
    $(document).on('click','.chasier_chassis_ul li', function(){
